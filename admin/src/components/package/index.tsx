...
const Catgoery = () => {
  ...
  const columns: ProColumns[] = [
    ...
    },
    {
      ...
      align: 'center',
      ellipsis: true,
      render: (_: any, row: any) => <div>{row?.price?.toLocaleString()}</div>,
    },
    {
      title: 'Default',
      sorter: false,
    ...
    <BasePageContainer breadcrumb={breadcrumb}>
      ...
      >
        <Form layout="vertical" onFinish={onSubmit}>
          ...
          <Form.Item label="Số lượng tạo sản phẩm" name={'limit'}>
            <Input className="h-[40px]" />
          </Form.Item>
          <Form.Item label="Giá gói" name={'price'}>
            <Input className="h-[40px]" />
          </Form.Item>
          <Form.Item label="Thời gian gói (tháng)" name={'time'}>
            <Input className="h-[40px]" />
          </Form.Item>
          <Form.Item label="Loại nhuận" name={'profit'}>
            <Input className="h-[40px]" />
          </Form.Item>
